...
print (cy+"Make sure you Subscribed Techno On Telegram @TechnoBot_Support")
print (cy+"https://github.com/TeamTechnot/Telegram-Scraper-Adder  | https://github.com/DOMINATOR-XD")
...
for user in users:
    ...
    try:
        ...
        print("Getting Flood Error from telegram. Script is fucking now. Please try again after some time.")
